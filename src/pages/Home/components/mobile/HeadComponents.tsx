    ...
    >
      ...
      >
        ...
        <button
          ...
          className="rounded-full bg-gradient-to-r from-[#2D1E4A] to-[#4B3A73] px-6 py-2 text-sm font-medium text-white shadow-md transition-all duration-300 hover:scale-105"
        >
          Explore Cars
        </button>
      </motion.div>
