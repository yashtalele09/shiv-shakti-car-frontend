...
const HeadComponents = () => {
  return (
    <div className="w-full relative bg-linear-to-br from-[#FFD9C9] to-[#CDC3FF] h-[42vh] z-0">
      <div className="w-full px-2 flex flex-col items-center gap-4 absolute top-45 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
        <Search />
