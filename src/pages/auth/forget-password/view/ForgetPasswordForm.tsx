    ...
    >
      <div className="flex flex-col gap-6 px-6 py-8">
        ...
        >
          ...
          >
            <KeyRound size={26} className="text-white" strokeWidth={1.8} />
          </div>
        ...
        <motion.div variants={itemVariants} className="flex flex-col gap-2">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="h-13 w-full rounded-2xl py-3.5 pr-4 pl-11 text-sm font-medium text-white placeholder-white/40 caret-white transition-all outline-none"
              style={{
